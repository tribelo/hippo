...
public class JcrDocumentUtilsTest {
    ...
    public void publish_publishesDocumentOfGivenHandle_usingDefaultWorkflow() throws Exception {
        ...
        given(WorkflowUtils.getWorkflow(any(Node.class), any(String.class), any())).willReturn(Optional.of(workflow));

        final Node documentHandleNode = aValidDocumentHandleNode();
    ...
    public void publish_throwsException_onFailure() throws RepositoryException {
        ...
        mockStatic(WorkflowUtils.class);
        given(WorkflowUtils.getWorkflow(any(Node.class), any(String.class), any())).willThrow(collaboratorException);
    ...
    public void documentManagerFor_returnsInstanceOfWorkflowDocumentManagerImpl_initialisedWithGivenSession() {
        ...
        // when
        final DocumentManager actualDocumentManager = JcrDocumentUtils.documentManagerFor(expectedSession);
    ...
    private Node aValidDocumentHandleNode() throws RepositoryException {
