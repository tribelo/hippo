...
public class DocumentLifecycleSupportTest {
    ...
    public void setProperty_updatesPropertyWithGivenValueOnDraftVariant() throws Exception {
        ...
        // when
        documentLifecycleSupport.setProperty(expectedPropertyName, expectedPropertyValue);
    ...
    public void getStringProperty_returnsPropertyValueFromNodeOfRequestedDocumentVariant() throws RepositoryException {
        ...
        final Optional<String> actualPropertyValue =
            documentLifecycleSupport.getStringProperty(propertyName, expectedDocumentVariantType);
    ...
    public void getStringProperty_throwsException_onFailure() {
        ...
        // when
        documentLifecycleSupport.getStringProperty("aPropertyName", UNPUBLISHED);
    ...
    public void getLastPublicationInstant_returnsValueFromNodeOfPublishedDocumentVariant() {
        ...
        // when
        final Optional<Instant> actualPropertyValue = documentLifecycleSupport.getLastPublicationInstant();
    ...
    public void getLastPublicationInstant_throwsException_onFailure() {
        ...
        // when
        documentLifecycleSupport.getLastPublicationInstant();
    ...
    public void saveAndPublish_throwsException_onSaveFailure() {
        ...
        // given
        documentLifecycleSupport // sets 'dirty' flag which enables 'save' and 'publish'
    ...
    public void from_returnsNewInstance_initialisedWithGivenHandleNode() {
        ...
        // when
        final DocumentLifecycleSupport documentLifecycleSupport = DocumentLifecycleSupport.from(documentHandleNode);

        // then
        final Node actualDocumentHandleNode =
            ReflectionTestUtils.readField(documentLifecycleSupport, "documentHandleNode");
