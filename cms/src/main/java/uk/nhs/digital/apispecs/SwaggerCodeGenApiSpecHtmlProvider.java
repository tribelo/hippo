...
public class SwaggerCodeGenApiSpecHtmlProvider implements ApiSpecHtmlProvider {

    private static final String SPEC_HTML_FILE_NAME = "index.html";
    private final ApigeeService apigeeService;

    public SwaggerCodeGenApiSpecHtmlProvider(final ApigeeService apigeeService) {
